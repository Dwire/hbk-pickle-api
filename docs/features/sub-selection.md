...
- src/shared/attendanceCoverage.ts: Shared segment math, 15-minute partial validation, registered auto-pairing, and effective occupancy calculations.
...
- Non-overlapping registered partial attendees are auto-paired (max cardinality START/END matching), reducing effective occupied slots before sub selection.
