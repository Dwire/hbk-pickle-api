...
ALTER TABLE "UserDevice" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "OrganizationMembership" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "LeagueMembership" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "LeagueRule" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "Session" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "SessionOccurrence" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "SlotAssignment" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "SessionRegistration" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "SubSignup" ALTER COLUMN "id" DROP DEFAULT;
